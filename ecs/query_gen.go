...
func (q *Query0) iter() iter.Seq[*queryResult0] {
	return func(yield func(*queryResult0) bool) {
		if q.cache != nil {
...
func (q *Query1[A]) iter() iter.Seq[*queryResult1[A]] {
...
func (q *Query2[A, B]) iter() iter.Seq[*queryResult2[A, B]] {
...
func (q *Query3[A, B, C]) iter() iter.Seq[*queryResult3[A, B, C]] {
...
func (q *Query4[A, B, C, D]) iter() iter.Seq[*queryResult4[A, B, C, D]] {
...
func (q *Query5[A, B, C, D, E]) iter() iter.Seq[*queryResult5[A, B, C, D, E]] {
...
func (q *Query6[A, B, C, D, E, F]) iter() iter.Seq[*queryResult6[A, B, C, D, E, F]] {
...
func (q *Query7[A, B, C, D, E, F, G]) iter() iter.Seq[*queryResult7[A, B, C, D, E, F, G]] {
...
func (q *Query8[A, B, C, D, E, F, G, H]) iter() iter.Seq[*queryResult8[A, B, C, D, E, F, G, H]] {
