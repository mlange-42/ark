...
- Adds an event system for ECS operations, like entity creation/removal and component addition/removal (#330, #331, #333)
...
- Adds a user guide chapter on the new event system (#334)
