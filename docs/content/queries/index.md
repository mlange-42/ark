...
{{< /html >}}  
*Benchmarks for the Position/Velocity example, Ark vs. Array of Structs. Note that the benchmarks as run on Github CI machines, which have a very large cache. On a normal PC, the advantage of Ark would be even larger.*
